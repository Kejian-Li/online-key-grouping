...
public class TwoUniversalHash {
     ...
     * @param prime        a prime number that must be larger than the cardinality of the
     *                     hash function domain.
     * @param a            a random non null integer modulo prime
     * @param b            a random integer modulo prime
     */
    public TwoUniversalHash(int codomainSize, long prime, long a, long b) {
